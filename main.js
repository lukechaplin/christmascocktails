...
let userInput = document
  .querySelector("#drink-input")
  .addEventListener("keyup", recordTyping);
...
function addingInstructions(string) {
  addInstructionsToHtml.innerText = string;
}
...
function addTheIngredient1(string) {
  addIngredient1.innerText = string;
}

function addTheIngredient2(string) {
  addIngredient2.innerText = string;
}

function addTheIngredient3(string) {
  addIngredient3.innerText = string;
}

function addTheIngredient4(string) {
  addIngredient4.innerText = string;
}

function addTheIngredient5(string) {
  addIngredient5.innerText = string;
}
...
function addMeasure1(string) {
  addingMeasure1.innerText = string;
}

function addMeasure2(string) {
  addingMeasure2.innerText = string;
}

function addMeasure3(string) {
  addingMeasure3.innerText = string;
}

function addMeasure4(string) {
  addingMeasure4.innerText = string;
}

function addMeasure5(string) {
  addingMeasure5.innerText = string;
}
...
async function fetchCocktails() {
  ...
  let removeCurlyBracketsForInstruct = convertObjectForInstruct.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForInstruct = removeCurlyBracketsForInstruct.replace(
    /[[\]]/g,
    ""
  );
  ...
  let removeCurlyBracketsForIngred1 = convertObjectForIngred1.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForIngred1 = removeCurlyBracketsForIngred1.replace(
    /[[\]]/g,
    ""
  );
  addTheIngredient1(removeSquareBracketsForIngred1);
  let convertObjectForIngred2 = JSON.stringify(data.drinks[0].strIngredient2);
  let removeCurlyBracketsForIngred2 = convertObjectForIngred2.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForIngred2 = removeCurlyBracketsForIngred2.replace(
    /[[\]]/g,
    ""
  );
  addTheIngredient2(removeSquareBracketsForIngred2);
  let convertObjectForIngred3 = JSON.stringify(data.drinks[0].strIngredient3);
  let removeCurlyBracketsForIngred3 = convertObjectForIngred3.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForIngred3 = removeCurlyBracketsForIngred3.replace(
    /[[\]]/g,
    ""
  );
  addTheIngredient3(removeSquareBracketsForIngred3);
  let convertObjectForIngred4 = JSON.stringify(data.drinks[0].strIngredient4);
  let removeCurlyBracketsForIngred4 = convertObjectForIngred4.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForIngred4 = removeCurlyBracketsForIngred4.replace(
    /[[\]]/g,
    ""
  );
  let removeNullforIngred4 = removeSquareBracketsForIngred4.replace(
    null,
    "N/A"
  );
  addTheIngredient4(removeNullforIngred4);
  let convertObjectForIngred5 = JSON.stringify(data.drinks[0].strIngredient5);
  let removeCurlyBracketsForIngred5 = convertObjectForIngred5.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForIngred5 = removeCurlyBracketsForIngred5.replace(
    /[[\]]/g,
    ""
  );
  let removeNullforIngred5 = removeSquareBracketsForIngred5.replace(
    null,
    "N/A"
  );
  addTheIngredient5(removeNullforIngred5);
  let convertObjectForMeasure1 = JSON.stringify(data.drinks[0].strMeasure1);
  let removeCurlyBracketsForMeasure1 = convertObjectForMeasure1.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForMeasure1 = removeCurlyBracketsForMeasure1.replace(
    /[[\]]/g,
    ""
  );
  addMeasure1(removeSquareBracketsForMeasure1);
  let convertObjectForMeasure2 = JSON.stringify(data.drinks[0].strMeasure2);
  let removeCurlyBracketsForMeasure2 = convertObjectForMeasure2.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForMeasure2 = removeCurlyBracketsForMeasure2.replace(
    /[[\]]/g,
    ""
  );
  addMeasure2(removeSquareBracketsForMeasure2);
  let convertObjectForMeasure3 = JSON.stringify(data.drinks[0].strMeasure3);
  let removeCurlyBracketsForMeasure3 = convertObjectForMeasure3.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForMeasure3 = removeCurlyBracketsForMeasure3.replace(
    /[[\]]/g,
    ""
  );
  addMeasure3(removeSquareBracketsForMeasure3);
  let convertObjectForMeasure4 = JSON.stringify(data.drinks[0].strMeasure4);
  let removeCurlyBracketsForMeasure4 = convertObjectForMeasure4.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForMeasure4 = removeCurlyBracketsForMeasure4.replace(
    /[[\]]/g,
    ""
  );
  let removeNullforMeasure4 = removeSquareBracketsForMeasure4.replace(
    null,
    "N/A"
  );
  addMeasure4(removeNullforMeasure4);
  let convertObjectForMeasure5 = JSON.stringify(data.drinks[0].strMeasure5);
  let removeCurlyBracketsForMeasure5 = convertObjectForMeasure5.replace(
    /[{}]/g,
    ""
  );
  let removeSquareBracketsForMeasure5 = removeCurlyBracketsForMeasure5.replace(
    /[[\]]/g,
    ""
  );
  let removeNullforMeasure5 = removeSquareBracketsForMeasure5.replace(
    null,
    "N/A"
  );
